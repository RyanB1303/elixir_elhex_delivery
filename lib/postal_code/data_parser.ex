defmodule ElhexDelivery.PostalCode.DataParser do
  @postal_codes_filepath "data/2022_Gaz_zcta_national.txt"
  ...
  defp parse_data_col(row) do
    [postal_code, _, _, _, _, latitude, longitude] = row
    [postal_code, latitude, longitude]
  end

  defp parse_number(num) do
    num |> String.replace(" ", "") |> String.to_float()
  end

  # format three element list [] into two element tuple {postal, {lat, long}}
